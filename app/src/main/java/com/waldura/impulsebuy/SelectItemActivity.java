...
public class SelectItemActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWalletFragment.setOnStateChangedListener(new WalletFragment.OnStateChangedListener() {
            ...
            public void onStateChanged(WalletFragment walletFragment, int oldState, int newState, Bundle bundle) {
                Log.i(ImpulseStore.TAG, "wallet fragment state changed: " + oldState + " -> " + newState);
            }
        });
        ...
        randomButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i(ImpulseStore.TAG, "item to buy: " + mItem);
                ...
                Log.i(ImpulseStore.TAG, "created wallet request " + maskedWalletRequest);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case WalletSupport.REQUEST_CODE_MASKED_WALLET:
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        Log.i(ImpulseStore.TAG, "activity result OK");
                    ...
                    case Activity.RESULT_CANCELED:
                        Log.i(ImpulseStore.TAG, "activity result cancelled");
                        break;
                    default:
                        Log.e(ImpulseStore.TAG, "activity result code not handled!");
            ...
            case WalletConstants.RESULT_ERROR:
                ...
                break;
            default:
                Log.w(ImpulseStore.TAG, "activity result default");
    ...
    private void launchConfirmationPage(MaskedWallet maskedWallet) {
        ...
        Log.i(ImpulseStore.TAG, "launched confirmation page");
    }
